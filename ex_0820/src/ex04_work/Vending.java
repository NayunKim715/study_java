...
public class Vending {
    ...
    private Can[] cans = new Can[5];//음료수를 여러 종류 준비. 5종류
    private int money;
    ...
    public void dispense( String name ){ //잔돈을 물리적으로 돌려주고 싶으면 int
       for( int i = 0; i < cans.length; i++ ){ //다섯번 돌면서 똑같은 게 있는지 찾는다
          if( cans[i].getName().equals( name ) ){ //String이니까 equals로 비교
